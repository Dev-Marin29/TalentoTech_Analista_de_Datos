...
cant_fresa=float(input("Digite cantidad de fresa a comprar >>> "))
cant_mango=int(input("Digite cantidad de mango a comprar >>> "))
cant_manzana=int(input("Digite cantidad de manzana a comprar >>> "))
